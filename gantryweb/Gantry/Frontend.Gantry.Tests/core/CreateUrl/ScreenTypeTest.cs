...
namespace Frontend.Gantry.Shared.Tests.core.CreateUrl
{
    ...
    public class ScreenTypeTest
    {
        ...
        public void SetQuadScreenType()
        {
            ...
            Assert.IsTrue(result == "http://dev.gantry.coral.co.uk/en/gantry/greyhoundsracing?eventId=4448839&marketIds=116663915&screenType=quad");
        }
        ...
        public void SetFullScreenType()
        {
            ...
            result = _screenType.SetScreenType(gantryScreen, result);
            Assert.IsTrue(result == "http://dev.gantry.coral.co.uk/en/gantry/greyhoundsracing?eventId=4448839&marketIds=116663915&screenType=full");
        }
        ...
        public void SetHalfScreenType()
        {
            ...
            result = _screenType.SetScreenType(gantryScreen, result);
            Assert.IsTrue(result == "http://dev.gantry.coral.co.uk/en/gantry/greyhoundsracing?eventId=4448839&marketIds=116663915&screenType=half");
        }
