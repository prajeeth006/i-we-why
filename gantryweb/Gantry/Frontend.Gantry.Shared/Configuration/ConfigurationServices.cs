...
namespace Frontend.Gantry.Shared.Configuration
{
    public static class ConfigurationServices
    {
        public static void AddGantryConfiguration(this IServiceCollection services)
        {
            ...
            services.AddConfiguration<IGantryGreyhoundSilkImages, GantryGreyhoundSilkImages>("Gantry.GreyhoundSilkImages");
            ...
            services.AddConfiguration<IGantryDesignConfiguration, GantryDesignConfiguration>("Gantry.DesignConfiguration");
        }
    }
}