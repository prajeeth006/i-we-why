import { HorseRacingMeetingResults, HorseRacingMeetingResultsTemplate, HorseRacingResultDetails, Totes } from "../../../models/horse-racing-meeting-results.model";
...
export class MockMeetingResultsMapData1 {
  ...
  listOfSelectionsTricast: Array<HorseRacingResultDetails> = [this.resultSelection1Tricast, this.resultSelection2Tricast, this.resultSelection3Tricast, this.resultSelection4Tricast];
