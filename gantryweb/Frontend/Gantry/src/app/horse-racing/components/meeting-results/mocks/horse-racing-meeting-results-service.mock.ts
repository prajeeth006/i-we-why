...
export class MockMeetingResultsMapData {
  ...
  listOfSelectionsTricast: Array<ResultSelection> = [this.resultSelection1Tricast, this.resultSelection2Tricast, this.resultSelection3Tricast, this.resultSelection4Tricast];
  ...
  typesTricast: Map<number, MeetingResultContent> = new Map<
    number,
    MeetingResultContent
  >([[1, this.meetingResultContent1Tricast]]);
