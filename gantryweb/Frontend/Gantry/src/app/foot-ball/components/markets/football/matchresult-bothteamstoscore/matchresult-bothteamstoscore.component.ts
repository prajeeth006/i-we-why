...
@Component({
  selector: 'gn-matchresult-bothteamstoscore',
  templateUrl: './matchresult-bothteamstoscore.component.html',
  styleUrls: ['./matchresult-bothteamstoscore.component.scss']
})
export class MatchresultBothteamstoscoreComponent implements OnInit {
