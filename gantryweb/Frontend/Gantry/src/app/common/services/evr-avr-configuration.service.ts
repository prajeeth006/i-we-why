...
export class EvrAvrConfigurationService {
    ...
    private evrAvrRaceBehaviorSubject = new BehaviorSubject<CheckEvrAvrByTypeId>({isAvrRace:null,isEvrRace:false});
    ...
    evrOffPageDelay$ = this.httpService.get<number>('en/api/getEvrOffPageDelay')
        .pipe(shareReplay());
