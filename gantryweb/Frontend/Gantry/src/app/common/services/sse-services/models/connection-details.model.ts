...
export class ConnectionDetails{
    ...
    snapShotTimeOut: NodeJS.Timeout = undefined;
    connectionTimeOutTimer: string = undefined;
    snapshotRetryTimeOutTimer: string = undefined;
    pendingConnectionRetryDelay: number = 10000;
    failedConnectionRetryDelay: number = 30000;
    snapshotRetryDelay: number = 20000;

    observer: Subscriber<string> = undefined;
