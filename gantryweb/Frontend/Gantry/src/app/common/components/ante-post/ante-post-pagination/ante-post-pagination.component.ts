...
@Component({
  selector: 'gn-ante-post-pagination',
  templateUrl: './ante-post-pagination.component.html',
  styleUrls: ['./ante-post-pagination.component.scss'],
  encapsulation: ViewEncapsulation.ShadowDom
})
export class AntePostPaginationComponent implements AfterViewInit, OnDestroy, OnChanges {
