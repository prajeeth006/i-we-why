...
@Component({
  selector: 'gn-ante-post-small',
  templateUrl: './ante-post-small.component.html',
  styleUrls: ['./ante-post-small.component.scss'],
  encapsulation: ViewEncapsulation.ShadowDom
})
export class AntePostSmallComponent  implements AfterViewInit, OnDestroy, OnChanges {
