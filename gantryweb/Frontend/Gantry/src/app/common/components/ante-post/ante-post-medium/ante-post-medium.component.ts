...
@Component({
  selector: 'gn-ante-post-medium',
  templateUrl: './ante-post-medium.component.html',
  styleUrls: ['./ante-post-medium.component.scss'],
  encapsulation: ViewEncapsulation.ShadowDom
})
export class AntePostMediumComponent  implements AfterViewInit, OnDestroy, OnChanges {
