...
import { TrapChallengeMockData } from '../mocks/mock-trap-challenge-data';
import { MockGreyhoundStaticContent } from '../mocks/mock-trap-challenge-data';
...
describe('TrapChallengeTemplateService', () => {
  ...
  it('check trap challenge event count should be match', () => {
    let response: TrapChallengeResult = service.prepareResult(trapChallengeMockData.sportBookResult, mockGreyhoundStaticContent.greyhoundRacingContent);
