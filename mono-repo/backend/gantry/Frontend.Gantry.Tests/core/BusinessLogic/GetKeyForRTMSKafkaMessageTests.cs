...
namespace Frontend.Gantry.Tests.core.BusinessLogic
{
    class GetKeyForRTMSKafkaMessageTests
    {
        ...
        public void getMessageKeyRTMSKafka()
        {
            ...
            NUnit.Framework.Legacy.ClassicAssert.AreEqual("CORAL_GANTRY21_1_QUAD_2", messageKey);
        }
        ...
        public void getMessageKeyRTMSKafkaShouldNotThrowException()
        {
            ...
            NUnit.Framework.Legacy.ClassicAssert.AreEqual("", messageKey);
        }
        [Test]
        public void getMessageKeyRTMSKafkaForSportsChannel()
        {
            ...
            NUnit.Framework.Legacy.ClassicAssert.AreEqual("CORAL_GANTRY 3*3_12345", messageKey);
        }
        ...
        public void getPresenceMessageKeyRTMSKafka()
        {
            ...
            NUnit.Framework.Legacy.ClassicAssert.AreEqual("CORAL_PresenceMessage_8091", messageKey);
        }
    }
}
