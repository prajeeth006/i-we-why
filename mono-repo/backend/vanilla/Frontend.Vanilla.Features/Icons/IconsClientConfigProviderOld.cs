...
internal class IconsClientConfigProviderOld(IContentService contentService, IThemeResolver themeResolver) : LambdaClientConfigProvider("vnIcons", async cancellationToken =>
{
...
{
    public override ClientConfigType Type => ClientConfigType.Eager;
