...
/****** Object:  StoredProcedure [dbo].[DeleteExpiredCacheItems_notsoOld_v2]    Script Date: 06/19/2023 1:34:19 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[DeleteExpiredCacheItems_notsoOld_v2]
...
--BEGIN ATOMIC WITH (TRANSACTION ISOLATION LEVEL = SNAPSHOT, LANGUAGE = N'us_english')
	...
	BEGIN TRY
		...
		DELETE top (1000000) [dbo].[CacheItems] where [Key] not in (select [Key] from [dbo].[CacheItems_Expiration])
		set @rows=@@ROWCOUNT
