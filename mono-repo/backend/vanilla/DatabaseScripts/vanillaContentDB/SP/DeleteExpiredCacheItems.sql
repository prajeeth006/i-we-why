...
/****** Object:  StoredProcedure [dbo].[DeleteExpiredCacheItems]    Script Date: 06/19/2023 1:29:27 PM ******/
SET ANSI_NULLS ON
GO
...
--BEGIN ATOMIC WITH (TRANSACTION ISOLATION LEVEL = SNAPSHOT, LANGUAGE = N'us_english')
	...
	BEGIN TRY
		...
		insert into [dbo].[VanillaContent_DELCount]  (ftimestampUTC, fdel_cacheItems_EXP, fdel_cacheItems) 
