...
/// </summary>
internal interface IGetContentCommand
{
    Task<Content<TDocument>> GetAsync<TDocument>(ExecutionMode mode, DocumentId id, ContentLoadOptions options)
        where TDocument : class, IDocument;
}

internal sealed class GetContentCommand(IContentLoader loader) : IGetContentCommand
{
    public async Task<Content<TDocument>> GetAsync<TDocument>(ExecutionMode mode, DocumentId id, ContentLoadOptions options)
        where TDocument : class, IDocument
    {
