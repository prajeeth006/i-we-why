...
import { LatestSixResultsContentService } from './latestsixresults-content.service';
...
export class LatestResultsService {
    ...
    setSISData(latestResults: LatestResults) {
        if (latestResults?.isVoidRace) {
            ...
            latestResults.isStewardEnquiry &&
            (latestResults?.showStewardsState === StewardType.stewardsState_S || latestResults?.showStewardsState === StewardType.stewardsState_R)
        ) {
