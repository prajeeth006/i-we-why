...
export class EpsFavorite2ServiceMocksData {
    ...
    market1: Map<number, SportBookMarketStructured> = new Map<number, SportBookMarketStructured>([[0, this.winOrEachway]]);
    ...
    epsEvent: Map<number, SportBookEPSEventStructured> = new Map<number, SportBookEPSEventStructured>([[0, this.event2]]);
