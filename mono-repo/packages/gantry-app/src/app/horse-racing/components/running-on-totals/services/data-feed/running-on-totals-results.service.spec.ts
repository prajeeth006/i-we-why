...
describe('RunningOnTotalsResultsService', () => {
    ...
    const runningOnTotalsResults: RunningOnTotalsContent = {
        typeDetails: [
            {
    ...
    const runningResultContent = new RunningResultContent();
    runningResultContent.runningOnTotals = runningOnTotalsResults.typeDetails[0];
    const tempResult: RunningTempResult = new RunningTempResult();
    const newTempResult: RunningTempResult = new RunningTempResult();
    ...
    const newRunningOnTotals = new RunningOnTotals();
    ...
    it('rpCourseId should not be null', () => {
        const market = runningOnTotalsResults.typeDetails[0];
