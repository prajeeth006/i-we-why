...
export class RunningOnTotalsServiceMocks {
    runningOnTotalsResults: RunningOnTotalsContent = {
        typeDetails: [
            ...
            {
                rpCourseName: 'CATTERICK',
                racesFinished: 7,
                rpCourseId: '1020220309',
                distanceToWinner: 29.05,
                openBetTypeIds: ['1907'],
                date: '123456',
                eventIds: new Map<string, Array<number>>(),
                isResulted: false,
            ...
            {
                rpCourseName: 'CHEPSTOW',
                racesFinished: 8,
                rpCourseId: '1220220226',
                distanceToWinner: 85.8,
                openBetTypeIds: ['1909'],
                date: '123456',
                eventIds: new Map<string, Array<number>>(),
                isResulted: false,
            ...
            {
                rpCourseName: 'CARLISLE',
                racesFinished: 4,
                rpCourseId: '820220310',
                distanceToWinner: 28.2,
                openBetTypeIds: ['1905'],
                date: '123456',
                eventIds: new Map<string, Array<number>>(),
                isResulted: false,
