...
import { ManualOutRightResult } from '../../../models/manual-outright.module';
...
export class ManualOutrightComponent implements AfterViewInit, OnDestroy, OnChanges, OnInit {
