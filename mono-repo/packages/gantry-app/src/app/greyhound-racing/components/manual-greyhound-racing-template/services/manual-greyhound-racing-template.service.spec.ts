...
describe('ManualGrayhoundRacingTemplateService', () => {
    ...
    it('when prepareRunnersContent with all required parameters called it should ', () => {
        racingResponse.manualGreyhoundRacingRunners = service.prepareRunnersContent(
    ...
    it('when prepareResultContent with all required parameters called it should ', () => {
        racingResponse.manualGreyhoundRacingResults = service.prepareResultContent(
            mockGreyhoundStaticContent.greyhoundRacingContent,
    ...
    it('premareevs if passed 1/1', () => {
        expect(service.prepareEvs('1/1')).toBe('EVS');
    });
