...
import { RtmsBonusTeaserComponent } from '../../../../features/rtms-overlay/src/components/overlays/rtms-bonus-teaser.component';
import { RtmsClientConfigMock } from '../../../../shared/rtms/test/stubs/rtms-mocks';
import { BonusResourceServiceMock } from '../mocks/bonus-resource.service.mock';

describe('test', () => {
    let fixtureComponent: ComponentFixture<RtmsBonusTeaserComponent>;
    let component: RtmsBonusTeaserComponent;
    ...
    function initComponent() {
        fixtureComponent = TestBed.createComponent(RtmsBonusTeaserComponent);
