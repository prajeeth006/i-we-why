...
@Component({
    ...
    selector: 'vn-rtms-desktop-games-locked-list',
    templateUrl: 'rtms-desktop-games-locked-list.component.html',
})
export class RtmsDesktopGamesLockedListComponent extends RtmsOverlayComponentBase implements OnInit, OnChanges {
