...
import { CashierService, Page, TimerService } from '@frontend/vanilla/core';
...
@Component({
    standalone: true,
    imports: [CommonModule, TrustAsHtmlPipe, ImageComponent, LhHeaderBarComponent, IconCustomComponent],
    selector: 'lh-rtms-layer-bonus-teaser',
    templateUrl: 'rtms-layer-bonus-teaser.component.html',
})
export class RtmsLayerBonusTeaserComponent extends RtmsLayerComponentBase implements OnInit {
