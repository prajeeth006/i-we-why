...
export const VIRTUAL_VIEW_CONFIG_TOKEN = new InjectionToken<RxVirtualViewConfig>('VIRTUAL_VIEW_CONFIG_TOKEN', {
    providedIn: 'root',
 ...
 */
export function provideVirtualViewConfig(config: Partial<RxVirtualViewConfig & { cache?: Partial<RxVirtualViewConfig['cache']> }>): Provider {
    return {
