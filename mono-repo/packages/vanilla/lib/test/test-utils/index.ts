...
export function setupComponentFactoryResolver() {
    (<ProductServiceMock>TestBed.inject<any>(ProductService)).current.componentFactoryResolver = TestBed.inject(ComponentFactoryResolver);
}

export const capturedExceptions: Record<string, any> = {
    opera_854: {
        'message':
    ...
    opera_1063: {
        ...
        stack:
            '<anonymous function: createException>([arguments not available])@file://localhost/G:/js/stacktrace.js:42\n' +
    ...
    opera_1216: {
        ...
        stacktrace:
            'Error thrown at line 4, column 6 in <anonymous function>(x) in http://localhost:63342/javascript-stacktrace/test/functional/ExceptionLab.js:\n' +
            '    x.undef();\n' +
    ...
    firefox_3_6_file: {
        ...
        name: 'TypeError',
        stack:
            '()@file:///home/user/js/stacktrace.js:44\n' +
