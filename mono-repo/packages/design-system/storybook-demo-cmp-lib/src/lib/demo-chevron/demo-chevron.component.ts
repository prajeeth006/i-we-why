...
@Component({
    selector: 'ds-demo-chevron',
    standalone: true,
    template: `
        <!-- eslint-disable-next-line @angular-eslint/template/no-inline-styles -->
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" [style.transform]="'rotate(' + rotation() + 'deg)'">
            <path
                fill-rule="evenodd"
                clip-rule="evenodd"
...
export class DemoChevronComponent {
    rotation = input<string | number>(0);
}
