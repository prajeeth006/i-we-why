...
/**
 * This resize observer is from Angular CDK copied over for not using their private class
 * https://github.com/angular/components/blob/main/src/cdk/observers/private/shared-resize-observer.ts
 */
